...
// Official Technology Stack Brand Inline SVGs (100% Reliable, Zero CDN Dependency)
const iconsArray = [
  ...
  },
  {
    ...
    component: () => (
      <svg className="w-6 h-6 rounded-xs" viewBox="0 0 128 128">
  ...
  {
    // Express.js Logo Badge
    component: () => (
      <span className="text-[10px] font-black tracking-tight text-zinc-900 dark:text-zinc-100 font-mono">
        EXPRESS
      </span>
    ),
    duration: 22,
  ...
  },
  {
    // Vite Official Logo
    component: () => (
      <svg className="w-6 h-6" viewBox="0 0 256 257">
        <defs>
