...
export function AnalyticsPage({ currentUser, theme = 'dark' }: AnalyticsPageProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className={isFaculty ? 'grid grid-cols-1 gap-6' : 'grid grid-cols-1 lg:grid-cols-2 gap-6'}>
        ...
        <div className={`p-6 rounded-3xl border flex flex-col ${
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs font-bold text-zinc-500 font-mono">
              Total: {overall.totalStudents} Students
            </span>
          </div>
        ...
        {/* Pie Chart 2: Only rendered for Admin Global Portal */}
        {!isFaculty && (
          <div className={`p-6 rounded-3xl border flex flex-col ${
            isDark ? 'bg-zinc-900/40 border-zinc-800' : 'bg-white border-[#e5e2d9]'
          }`}>
